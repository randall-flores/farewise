  ...
  input_schema: {
    ...
    properties: {
      summary: {
        type: "string",
        description:
          "2-3 sentences in the FareWise voice (transactional, plain language, no airline jargon). Name the best-balance pick, the easiest (fewest-hassle) pick, and which option(s) to be cautious about. Use airline names and the real prices from the data.",
      },
      flights: {
        type: "array",
