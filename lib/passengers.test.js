...
describe("passengerSummary", () => {
  ...
  it("merges babies with a seat and babies on a lap into one count", () => {
    expect(passengerSummary({ adults: 2, children: 0, infantsInSeat: 1, infantsOnLap: 0 })).toBe("2 adults, 1 baby");
    expect(passengerSummary({ adults: 2, children: 0, infantsInSeat: 1, infantsOnLap: 1 })).toBe("2 adults, 2 babies");
  });
  it("combines all types", () => {
    expect(passengerSummary({ adults: 2, children: 1, infantsInSeat: 1, infantsOnLap: 1 })).toBe("2 adults, 1 child, 2 babies");
  });
});
