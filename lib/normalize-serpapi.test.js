...
import { normalizeSerpFlight, normalizeSerpApi } from "./normalize-serpapi.js";
...
describe("normalizeSerpFlight — TAP 1-stop", () => {
  ...
  it("treats it as a single, protected ticket", () => {
  ...
  it("does NOT fetch a booking link; keeps the departure_token for later", () => {
